...
if ($limit == -1) {
    ...
    $query = "SELECT * FROM tbl_request ORDER BY id DESC LIMIT $start, $limit";
}
...
<html>
<head>
    <title>Laporan Permintaan Peminjaman</title>
    <style>
        ...
        .btn { padding: 3px 6px; border-radius: 3px; text-decoration: none; color: #fff; }
...
<h2>LAPORAN PERMINTAAN PEMINJAMAN</h2>
