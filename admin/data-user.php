<?php
    ...
    trace_event("OPEN PAGE admin/data-user.php");
...
<body>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="tambah-admin.php" class="btn btn-success btn-sm" style="margin-left: 20px;">
    ...
    <script>
        function cetakLaporan() {
            ...
            window.open('cetak_data_user.php?limit=' + length + '&start=' + start, '_blank');
        }
