...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            trace_event("RUN QUERY SELECT * FROM tbl_request ORDER BY id DESC");
                            if($query){
                                $no = 1;
                                while ($data=mysqli_fetch_array($query)) {
                                    trace_event("FETCH DATA id=".$data['id'].", nama_barang=".$data['nama_barang']);
                                    $id          = $data['id'];
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="proses-pinjam.php?mode=terima&id=<?php echo $id;?>"
                                                        class="btn btn-success btn-sm btn-terima">
                                                        <i class="fa fa-check"></i> Terima
                                                    </a>
                                                    <a href="proses-pinjam.php?mode=tolak&id=<?php echo $id;?>"
                                ...
                                trace_event("QUERY GAGAL: ".mysqli_error($conn));
                        ?>
                                        <tr>
    ...
    <script>
        function cetakLaporan(e) {
            ...
            window.open(
                'cetak_permintaan_pinjam.php?limit=' + length + '&start=' + start,
                '_blank'
            );
        }
    ...
    <script>
		document.querySelectorAll('.btn-terima, btn-tolak').forEach(function (btn) {
