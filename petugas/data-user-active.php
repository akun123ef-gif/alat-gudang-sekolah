<?php
    ...
    trace_event("OPEN PAGE petugas/data-user=active.php");
?>
<!doctype html>
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>User Aktif
                            <a href="data-user-active.php" class="btn btn-info btn-sm">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">User Aktif</strong>
                            </div>
                            <div class="card-body">
                            ...
                            $query = mysqli_query($conn,"SELECT * FROM user_log ORDER BY id");
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <span class="<?php echo $colorClass; ?> mr-1">
