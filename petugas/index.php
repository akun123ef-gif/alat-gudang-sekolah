<?php
    ...
    include '../config.php';
    include '../db.php';
    trace_event("OPEN PAGE petugas/dashboard.php");
                        ...
                        <h4 class="mb-0">
                            <span class="count">
                                <?php
                                    ...
                                    trace_event("RUN QUERY SUM(jml_barang) AS jml_barnag FROM tbl_pinjam");
                                    $total_barang_pinjam = mysqli_fetch_array($query_barang_pinjam);
                                    trace_event("FETCH DATA jml_barnag=".$total_barang_pinjam['jml_barnag']);
