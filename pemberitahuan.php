				...
				<div class='row'>
					...
					<div class="col-md-5 form-register-container">
						<?php
							...
							trace_event("OPEN FILE pemberitahuan.php");

							$username = $_GET['username'];

							$sql = "SELECT * FROM pemberitahuan WHERE username='$username' ORDER BY timestamp DESC";
							trace_event("RUN SQL : $sql");

							$query = mysqli_query($conn,$sql);

							if(mysqli_num_rows($query) > 0){

								trace_event("DATA FOUND FOR USER $username");
						...
						<?php
								...
								trace_event("NO DATA FOUND FOR USER $username");
						?>
